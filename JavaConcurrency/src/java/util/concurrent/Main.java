...
public class Main {
	...
	public static void main(String[] args) {
		...
		MyConsumer consumer1 = new MyConsumer(buffer,ThreadColor.ANSI_PRUBLE);
		MyConsumer consumer2 = new MyConsumer(buffer,ThreadColor.ANSI_PRUBLE);
		MyConsumer consumer3 = new MyConsumer(buffer,ThreadColor.ANSI_PRUBLE);
